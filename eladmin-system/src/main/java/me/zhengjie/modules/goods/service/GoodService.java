...
public interface GoodService {
     ...
     * @param resources /
     */
    void create(Good resources);

    /**
     * 编辑
     * @param resources /
     */
    void update(Good resources);
     ...
     * @return /
     */
    PageResult<Good> queryAll(GoodQueryCriteria criteria, Page<Object> page);
     ...
     * @return /
     */
    List<Good> queryAll(GoodQueryCriteria criteria);
     ...
     * @throws IOException /
     */
    void download(List<Good> stores, HttpServletResponse response) throws IOException;
