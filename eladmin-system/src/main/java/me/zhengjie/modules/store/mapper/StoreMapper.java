...
public interface StoreMapper extends BaseMapper<StoreEntity> {
    ...
    List<StoreEntity> findAll(@Param("criteria") StoreQueryCriteria criteria);

    IPage<StoreEntity> findAll(@Param("criteria") StoreQueryCriteria criteria, Page<Object> page);

    @Select("select id from qbs_store where name = #{name}")
