...
public interface AreaMapper extends BaseMapper<Area> {
    ...
    List<Area> findAll(@Param("criteria") AreaQueryCriteria criteria);

    IPage<Area> findAll(@Param("criteria") AreaQueryCriteria criteria, Page<Object> page);

    @Select("select id from qbs_area where name = #{name}")
