...
public interface AreaService {
     ...
     * @param resources /
     */
    void create(Area resources);

    /**
     * 编辑
     * @param resources /
     */
    void update(Area resources);
     ...
     * @return /
     */
    PageResult<Area> queryAll(AreaQueryCriteria criteria, Page<Object> page);
     ...
     * @throws IOException /
     */
    void download(List<Area> stores, HttpServletResponse response) throws IOException;
