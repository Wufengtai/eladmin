...
public interface OrderService {
    ...
    // 根据身份证获取货品
    List<Order> getGoodByIc(String ic);
     ...
     * @return /
     */
    PageResult<Order> queryAll(String username, OrderQueryCriteria criteria, Page<Object> page);
     ...
     * @throws IOException /
     */
    void download(List<Order> stores, HttpServletResponse response) throws IOException;
